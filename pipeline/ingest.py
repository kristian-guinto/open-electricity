...
def app():
    ...
    parser = argparse.ArgumentParser(description="OpenNEM Philippines Ingestion CLI")
    parser.add_argument(
        "--mode",
        choices=["daily", "backfill", "sync-facilities"],
        default="daily",
        help="Run mode",
    )
    parser.add_argument(
    ...
    if args.mode == "daily" and not start_d:
        today = date.today()
